const Plateau = ({taille}) => {
        return (
            <svg className="quadrillage" viewBox={`0 0 100 100`} preserveAspectRatio="none">
                ...
                <rect className="contour" x="10" y="10" width="80" height="80" strokeWidth="0.5" fill="none" rx="0.25" ry="0.25"/>
                {/* Petit contour noir qui entour les lignes */}
                <rect x="10.3" y="10.3" width="79.4" height="79.4" strokeWidth="0.25" stroke="#1E1E1E" fill="none"/>
